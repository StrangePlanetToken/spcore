...
contract TokenVesting is Ownable {
  ...
  event Unlock(address indexed addr, uint256 amt);
  event Lock(address indexed addr, uint256 amt);
  
  constructor() public {
      start = 10822100;      // start block number
      cliff = start + 1200;
      duration = blocksPerDay.mul(365*5);      // period 
  }
